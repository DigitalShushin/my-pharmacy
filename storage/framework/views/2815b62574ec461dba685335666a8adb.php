                    ...
                    <tbody class="list form-check-all">
                            ...
                            <tr data-row-id="<?php echo e($company->id); ?>">
                                ...
                                <td class="name">
                                    <div class="d-flex align-items-center">
                                        <!-- <div class="flex-shrink-0">
                                            <img src="<?php echo e(asset('build/images/users/' . $company->avatar)); ?>" alt="" class="avatar-xs rounded-circle">
                                        </div> -->
                                        <div class="flex-grow-1 ms-2"><?php echo e($company->parent ? $company->parent->name : ''); ?></div>
                                    </div>
                                </td>
                                <td class="company_name"><?php echo e($company->name); ?></td>
                                <!-- <td class="email_id"><?php echo e($company->email); ?></td>
                                <td class="phone"><?php echo e($company->phone); ?></td>
                                <td class="lead_score"><?php echo e($company->lead_score); ?></td>
                                <td class="tags">
                                    <?php $__currentLoopData = explode(',', $company->tags); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="badge badge-soft-primary"><?php echo e($tag); ?></span>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </td>
                                <td class="date"><?php echo e(\Carbon\Carbon::parse($company->last_contacted)->format('d M, Y h:i A')); ?></td> -->
                                <td>
                                    <ul class="list-inline hstack gap-2 mb-0">
                                        <li>
                                            ...
                                            data-parent-id="<?php echo e($company->parent_id); ?>">
                                            <i class="ri-pencil-fill align-bottom me-2 text-muted" title="Edit"></i>
                                            </a>
                                        </li>                                        
                                        <li>
                                            <a class="list-inline-item remove-item-btn" data-bs-toggle="modal" href="#deleteRecordModal" data-company-id="<?php echo e($company->id); ?>">
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            <div class="pagination-wrap hstack gap-2">
                                <!-- Previous button -->
                                <a class="page-item pagination-prev <?php echo e($companies->onFirstPage() ? 'disabled' : ''); ?>" href="<?php echo e($companies->previousPageUrl()); ?>">
                                    Previous
                                </a>
                                ...
                                <ul class="pagination listjs-pagination mb-0">
                                    <?php $__currentLoopData = $companies->getUrlRange(1, $companies->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="page-item <?php echo e($page == $companies->currentPage() ? 'active' : ''); ?>">
                                ...
                                <!-- Next button -->
                                <a class="page-item pagination-next <?php echo e($companies->hasMorePages() ? '' : 'disabled'); ?>" href="<?php echo e($companies->nextPageUrl()); ?>">
                                    Next
                                </a>
                            </div>
