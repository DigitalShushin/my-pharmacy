        ...
        <div class="col-xxl-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Edit Purchase</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="invoice_number" id="invoiceInput"
                                            value="<?php echo e(old('invoice_number', $purchase->invoice_number)); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="purchase_date" id="nepaliDate"
                                            value="<?php echo e(old('purchase_date', $purchase->purchase_date)); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <table class="table table-bordered" id="productTable">
                                        ...
                                        <tbody>
                                            <?php if(!empty($purchase->stocks )): ?>
                                                <?php $__currentLoopData = $purchase->stocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>
                                                        <select name="products[<?php echo e($index); ?>][product_id]" class="form-control select2" required>
                                                            <option value="" disabled>Select Product</option>
                                                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($p->id); ?>" <?php echo e($product->product_id == $p->id ? 'selected' : ''); ?>><?php echo e($p->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </td>
                                                    <td><input type="number" name="products[<?php echo e($index); ?>][pack]" value="<?php echo e($product->pack); ?>" class="form-control"></td>
                                                    <td><input type="text" name="products[<?php echo e($index); ?>][batch]" value="<?php echo e($product->batch); ?>" class="form-control"></td>
                                                    <td><input type="date" name="products[<?php echo e($index); ?>][expiry_date]" value="<?php echo e($product->expiry_date); ?>" class="form-control"></td>
                                                    <td><input type="number" name="products[<?php echo e($index); ?>][quantity]" value="<?php echo e($product->quantity); ?>" class="form-control"></td>
                                                    <td><input type="number" name="products[<?php echo e($index); ?>][bonus]" value="<?php echo e($product->bonus); ?>" class="form-control"></td>
                                                    <td><input type="text" name="products[<?php echo e($index); ?>][rate]" value="<?php echo e($product->rate); ?>" class="form-control"></td>
                                                    <td><input type="number" step="0.1" min="0" name="products[<?php echo e($index); ?>][cc]" value="<?php echo e($product->cc); ?>" class="form-control"></td>
                                                    <td><input type="text" name="products[<?php echo e($index); ?>][cc_on_bonus]" value="<?php echo e($product->cc_on_bonus); ?>" class="form-control"></td>
                                                    <td><input type="text" name="products[<?php echo e($index); ?>][amount]" value="<?php echo e($product->quantity * $product->rate + $product->cc_on_bonus); ?>" class="form-control"></td>
                                                    <td><input type="text" name="products[<?php echo e($index); ?>][sp]" value="<?php echo e($product->selling_price); ?>"  class="form-control"></td>
                                ...
                                <div class="col-md-12 d-flex justify-content-between">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <input type="text" class="form-control" name="net_amount" value="<?php echo e(old('net_amount', $purchase->net_amount)); ?>" placeholder="Enter net amount" id="netamountInput">
                                        </div>

                                        <!-- Discount -->
                                        <div class="d-flex align-items-center mb-3">
                                            <label for="discountNumber" class="form-label me-2" style="min-width: 120px;">Discount</label>
                                            <input type="text" class="form-control" name="discount" value="<?php echo e(old('discount', $purchase->discount)); ?>" placeholder="Enter discount amount" id="discountNumber">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            <div class="d-flex align-items-center me-3" style="min-width: 110px;">
                                                <input class="form-check-input me-2" type="checkbox" id="vatToggle" <?php echo e(old('vat', $purchase->vat) ? 'checked' : ''); ?>>
                                                <label class="form-check-label mb-0" for="vatToggle">Apply VAT</label>
                                            </div>
                                            <input type="text" class="form-control" name="vat" value="<?php echo e(old('vat', $purchase->vat)); ?>" id="vatInput">
                                        </div>

                                        <!-- Total Amount -->
                                        <div class="d-flex align-items-center mb-3">
                                            <label for="totalAmount" class="form-label me-2" style="min-width: 120px;">Total Amount</label>
                                            <input type="text" class="form-control" name="total_amount" value="<?php echo e(old('total_amount', $purchase->total_amount)); ?>" placeholder="Enter total amount" id="totalAmount">
                                        </div>
                                    </div>
                                </div>
...
<!-- Calculate Amount of value input by user -->
<script>
document.addEventListener('DOMContentLoaded', function () {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\shushin_projects\pharmacy-laravel\resources\views/purchases/edit.blade.php ENDPATH**/ ?>