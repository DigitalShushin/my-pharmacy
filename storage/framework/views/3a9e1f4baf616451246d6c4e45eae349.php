    ...
    <div class="col-xxl-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Add Sale</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" name="customer_person" id="customer_person" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="date" name="sales_date" id="sales_date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered" id="salesItemsTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <select name="sales[0][product_id]" class="form-control select2" data-row="0" required>
                                                ...
                                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <option value="<?php echo e($product->id); ?>"
                                                            ...
                                                            <?php echo e(old('products.0.product_id') == $product->id ? 'selected' : ''); ?>>
                                                        <?php echo e($product->name); ?> (In Stock: <?php echo e($product->stock); ?>)
                                                    </option>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <!-- <td><input type="text" name="sales[0][product_id]" class="form-control"></td> -->
                                        <!-- <td><input type="text" name="sales[0][stock_id]" class="form-control"></td> -->
                                        <td><input type="number" name="sales[0][quantity]" class="form-control" data-row="0" min="1" required></td>
                                        <td><input type="text" name="sales[0][rate]" class="form-control" data-row="0" readonly></td>
                                        <td><input type="text" name="sales[0][amount]" class="form-control" data-row="0"></td>
                        ...
                        <div class="col-md-12 d-flex justify-content-between">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <input type="text" name="net_amount" class="form-control" id="netamountInput">
                                </div>

                                <div class="d-flex align-items-center mb-3">
                                    <label for="discount_percent" class="form-label me-2">Discount Percentage (%)</label>
                                    <input type="number" name="discount_percent" class="form-control" min="0" max="100" step="0.01" id="discountPercentage">
                                </div>

                                <div class="d-flex align-items-center mb-3">
                                    <label for="totalAmount" class="form-label me-2" style="min-width: 120px;">Discount</label>
                                    <input type="text" name="discount" class="form-control" placeholder="Enter discount amount" id="discountNumber">
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\shushin_projects\pharmacy-laravel\resources\views/sales/create.blade.php ENDPATH**/ ?>