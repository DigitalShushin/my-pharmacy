                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Enter company name" id="companyNameinput" value="<?php echo e($supplier->name); ?>" required>
                            </div>
                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="companies_array[]" 
                                                    ...
                                                    id="company_<?php echo e($company->id); ?>"
                                                    <?php echo e(in_array($company->id, $selectedCompanies) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\my-pharmacy\resources\views/suppliers/edit.blade.php ENDPATH**/ ?>