...
<div class="row">
    <div class="col-xxl-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="live-preview">
                    <form action="<?php echo e(route('sale-returns.store', $sale->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="customer_phone" id="customer_phone" class="form-control" value="<?php echo e(old('customer_phone', optional($sale->customer)->phone)); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="customer_name" id="customer_name" class="form-control" value="<?php echo e(old('customer_name', optional($sale->customer)->name)); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="customer_address" id="customer_address" class="form-control" value="<?php echo e(old('customer_address', optional($sale->customer)->address)); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="customer_person" id="customer_person" class="form-control" value="<?php echo e(old('contact_person', optional($sale->customer)->contact_person)); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="customer_email" id="customer_email" class="form-control" value="<?php echo e(old('customer_email', optional($sale->customer)->email)); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="sales_date" id="sales_date" class="form-control" value="<?php echo e(old('sales_date', $sale->sales_date)); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="return_date" id="return_date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <table class="table table-bordered" id="salesItemsTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="selected_items[]" value="<?php echo e($index); ?>">
                                                <input type="hidden" name="sales[<?php echo e($index); ?>][sale_item_id]" value="<?php echo e($item->id); ?>">
                                            </td>
                                            <td>
                                                <input type="number" name="sales[<?php echo e($index); ?>][return_quantity]" class="form-control">
                                            </td>

                                            <td>
                                                <select name="sales[<?php echo e($index); ?>][product_id]" class="form-control select2" data-row="<?php echo e($index); ?>" required>
                                                    <option value="" disabled>Select Product</option>
                                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($product->id); ?>"
                                                                data-selling-price="<?php echo e($product->selling_price); ?>"
                                                                data-stock="<?php echo e($product->stock); ?>"
                                                                <?php echo e(old("sales.$index.product_id", $item->product_id) == $product->id ? 'selected' : ''); ?>>
                                            ...
                                            <td><input type="number" name="sales[<?php echo e($index); ?>][quantity]" class="form-control" data-row="<?php echo e($index); ?>" required value="<?php echo e(old("sales.$index.quantity", $item->quantity)); ?>"></td>
                                            <td><input type="text" name="sales[<?php echo e($index); ?>][rate]" class="form-control" data-row="<?php echo e($index); ?>" value="<?php echo e(old("sales.$index.rate", $item->rate)); ?>" readonly></td>
                                            <td><input type="text" name="sales[<?php echo e($index); ?>][amount]" class="form-control" data-row="<?php echo e($index); ?>" value="<?php echo e(old("sales.$index.amount", $item->quantity * $item->rate)); ?>"></td>
                            ...
                            <div class="col-md-12 d-flex justify-content-between">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <input type="text" name="net_amount" class="form-control" id="netamountInput" value="<?php echo e(old('net_amount', $sale->net_amount)); ?>" readonly>
                                    </div>

                                    <div class="d-flex align-items-center mb-3">
                                        <label for="discount_percent" class="form-label me-2">Discount Percentage (%)</label>
                                        <input type="number" name="discount_percent" class="form-control" min="0" max="100" step="0.01" value="<?php echo e(old('discount_percentage', $sale->discount_percentage ?? '')); ?>" id="discountPercentage" readonly>
                                    </div>
                                    
                                    <div class="d-flex align-items-center mb-3">
                                        <label for="discount" class="form-label me-2" style="min-width: 120px;">Discount</label>
                                        <input type="text" name="discount" class="form-control" value="<?php echo e(old('discount', $sale->discount)); ?>" id="discountNumber" readonly>
                                    </div>

                                    <div class="d-flex align-items-center mb-3">
                                        <label for="totalAmount" class="form-label me-2" style="min-width: 120px;">Total Amount</label>
                                        <input type="text" name="total_amount" class="form-control" id="totalAmount" value="<?php echo e(old('total_amount', $sale->total_amount)); ?>" readonly>
                                    </div>        
        ...
        <?php if($previousReturns->isEmpty()): ?>
            ...
            <div class="card-body">                
                <div class="col-12">
                    <table class="table table-bordered" id="salesItemsTable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $previousReturns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $return): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\shushin_projects\pharmacy-laravel\resources\views/sale-returns/create.blade.php ENDPATH**/ ?>