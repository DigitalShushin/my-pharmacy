                ...
                <div class="card-header">
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        <div class="d-flex flex-grow-1 gap-2">
                            <h2>Suppliers</h2>
                            <a href="<?php echo e(route('suppliers.create')); ?>" class="btn btn-info add-btn">                                
                                    ...
                                    <tr>
                                        ...
                                        <td class="name">
                                            <div class="d-flex align-items-center">                                                
                                                <div class="flex-grow-1 ms-2 name"><?php echo e($supplier->name); ?></div>
                                            </div>
                                        </td>
                                        ...
                                        <!-- <td class="contact_person"><?php echo e($supplier->contact_person); ?></td>
                                         <td class="phone"><?php echo e($supplier->phone); ?></td>
                                        <td class="email_id"><?php echo e($supplier->email); ?></td>
                                        <td class="address"><?php echo e($supplier->address); ?></td>
                                        <td class="companies_array"><?php echo e($supplier->companies_array); ?></td>
                                        <td class="pan"><?php echo e($supplier->pan_number); ?></td>
                                        <td class="dda"><?php echo e($supplier->registration_number); ?></td> -->
