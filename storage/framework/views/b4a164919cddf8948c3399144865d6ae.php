                                            ...
                                            <select name="sales[<?php echo e($index); ?>][product_id]" class="form-control select2" data-row="<?php echo e($index); ?>" required>
                                                ...
                                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <option value="<?php echo e($product->id); ?>"
                                                        ...
                                                        <?php echo e($product->name); ?> (In Stock: <?php echo e($product->stock); ?>)
                                                    </option>
                                                    <?php endif; ?>
                        ...
                        <div class="col-md-12 d-flex justify-content-between">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <input type="text" name="net_amount" class="form-control" id="netamountInput" value="<?php echo e(old('net_amount', $sale->net_amount)); ?>">
                                </div>

                                <div class="d-flex align-items-center mb-3">
                                    <label for="discount_percent" class="form-label me-2">Discount Percentage (%)</label>
                                    <input type="number" name="discount_percent" class="form-control" min="0" max="100" step="0.01" value="<?php echo e(old('discount_percentage', $sale->discount_percentage ?? '')); ?>" id="discountPercentage">
                                </div>

                                <div class="d-flex align-items-center mb-3">
                                    <label for="totalAmount" class="form-label me-2" style="min-width: 120px;">Discount</label>
                                    <input type="text" name="discount" class="form-control" value="<?php echo e(old('discount', $sale->discount)); ?>" id="discountNumber">
                                </div>

                                <div class="d-flex align-items-center mb-3">
                                    <label for="totalAmount" class="form-label me-2" style="min-width: 120px;">Total Amount</label>
                                    <input type="text" name="total_amount" class="form-control" id="totalAmount" value="<?php echo e(old('total_amount', $sale->total_amount)); ?>">
                                </div>        
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\shushin_projects\pharmacy-laravel\resources\views/sales/edit.blade.php ENDPATH**/ ?>