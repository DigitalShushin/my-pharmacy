        ...
        <div class="container-fluid">
            ...
            */?>
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarSupplier" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps2">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('purchases.index')); ?>" class="nav-link">List</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('purchases.create')); ?>" class="nav-link">Add New</a>
                            </li>                            
                        </ul>
                    </div>
                </li><!-- end Dashboard Menu -->  
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps4" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                        <i class="las la-tags"></i> <span>Sales</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarApps4">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('sales.index')); ?>" class="nav-link">List</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('sales.create')); ?>" class="nav-link">Add New</a>
                            </li>                            
                            <li class="nav-item">
                                <a href="<?php echo e(route('sale-returns.index')); ?>" class="nav-link">Sale Returns</a>
                            </li>                            
                        </ul>
                    </div>
                </li><!-- end Dashboard Menu --> 
...
<?php /**PATH D:\shushin_projects\pharmacy-laravel\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>