...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="admin" class="logo logo-light">
            <span class="logo-sm">
                <img src="{{ URL::asset('/images/pharmacy-logo.png') }}" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src="{{ URL::asset('/images/pharmacy-logo.png') }}" alt="" height="17">
            </span>
        </a>
                ...
                */ ?>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarSupplier">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                            <a href="{{ route('suppliers.index') }}" class="nav-link">List</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('suppliers.create') }}" class="nav-link">Add New</a>
                            </li>                            
                        </ul>
                    </div>
                </li><!-- end Supplier -->
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps3">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('products.minimum-stock') }}" class="nav-link">Order List</a>
                            </li>                            
                        </ul>
                    </div>
                </li><!-- end Dashboard Menu --> 
