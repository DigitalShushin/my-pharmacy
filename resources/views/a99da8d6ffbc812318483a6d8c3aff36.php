...
<?php $__env->startSection('title'); ?> suppliers <?php $__env->stopSection(); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <script id="category-data" type="application/json">
                    <!-- <?php echo json_encode($suppliers); ?> -->
                </script>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\my-pharmacy\resources\views/apps-supplier.blade.php ENDPATH**/ ?>